...
$result = mysqli_query($con, "select TeamMember.Student_ID, TeamMember.First_Name, TeamMember.Last_Name, SecretPlace.Lat, SecretPlace.long_param from TeamMember join SecretPlace where TeamMember.Student_ID = SecretPlace.Student_ID;");
